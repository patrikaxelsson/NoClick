...
NoClick.mos: Startup.c Resident.c ResidentInit.c NoClick.c ResidentEnd.c ResidentInit.h NoClick.h ResidentEnd.h Makefile
	vc +morphos -nostdlib -O1 -use-lmw -D__NOLIBBASE__ -o $@ Startup.c Resident.c ResidentInit.c NoClick.c ResidentEnd.c

NoClick.os4: Startup.c Resident.c ResidentInit.c NoClick.c ResidentEnd.c ResidentInit.h NoClick.h ResidentEnd.h Makefile
	vc +aosppc -nostdlib -O1 -use-lmw -D__USE_INLINE__ -D__NOLIBBASE__ -D__NOGLOBALIFACE__ -o $@ Startup.c Resident.c ResidentInit.c NoClick.c ResidentEnd.c
